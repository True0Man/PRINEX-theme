...
/* tekst sekcji wyrównany do tytułu (h2 na 53px = 38 kółko + 15 gap).
   W listach: zielony „-" NA linii tytułu (53px), tekst za nim (hanging indent). */
.pp-scope .pp-section>p{padding-left:53px;}
.pp-scope .pp-section>ul{padding-left:51px;}
